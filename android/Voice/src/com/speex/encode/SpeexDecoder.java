...
import com.speex.writer.OggCrc;
public class SpeexDecoder {
	...
	private void initializeAndroidAudio(int sampleRate) throws Exception {
		...
		track = new AudioTrack(streamType, sampleRate, AudioFormat.CHANNEL_OUT_MONO, AudioFormat.ENCODING_PCM_16BIT,
	...
	public synchronized void decode() {
		...
		try {
			dis = new RandomAccessFile(new File(srcPath), "r");
		int origchksum = 0;
		int chksum = 0;
			// read until we get to EOF
			while (chksum == origchksum) {
